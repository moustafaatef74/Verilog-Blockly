...
Blockly.JavaScript['module'] = function(block) {
  ...
  var code = 'module '+ text_name+'('+statements_value.substring(2,statements_value.length);
  if(statements_value !=""){
...
Blockly.JavaScript['input'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
    if(number_bit ==  1){
	var code = 'input '+ text_value +', ';
	}
	else{
	var x = number_bit-1;
		var code = 'output ['+x+':0] '+ text_value +', ';
	}
  return code;
};
...
Blockly.JavaScript['wire'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
    if(number_bit ==  1){
	var code = 'wire '+ text_value +', ';
	}
	else{
	var x = number_bit-1;
		var code = 'wire ['+x+':0] '+ text_value +', ';
	}
  return code;
};
...
Blockly.JavaScript['reg'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
    if(number_bit ==  1){
	var code = 'reg '+ text_value +', ';
	}
	else{
	var x = number_bit-1;
		var code = 'reg ['+x+':0] '+ text_value +', ';
	}
  return code;
};
...
Blockly.JavaScript['gate'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = '	'+dropdown_gate+' ('+text_output+','+text_input1 +','+text_input2 +');\n';
  return code;
};
Blockly.JavaScript['endmodule'] = function(block) {
  // TODO: Assemble JavaScript into code variable.
  var code = 'endmodule\n';
  return code;
};

Blockly.JavaScript['always'] = function(block) {
  var statements_name = Blockly.JavaScript.statementToCode(block, 'NAME');
  // TODO: Assemble JavaScript into code variable.
  statements_name = statements_name.substring(2,statements_name.length)
  statements_name = statements_name.replace(/input /g,'');
  statements_name = statements_name.replace(/output /g,'');
  statements_name = statements_name.replace(/clock /g,'');
  statements_name = statements_name.replace(/wire /g,'');
  statements_name = statements_name.replace(/reg /g,'');
  statements_name = statements_name.replace(/,/g,'');
  statements_name = statements_name.substring(statements_name.indexOf("]") + 1);
  //statements_name = statements_name.replace(/ /g,'');
  var code = '	always @ (' + statements_name + ')\n';
  return code;
};
...
Blockly.JavaScript['gateinout'] = function(block) {
  var dropdown_gate = block.getFieldValue('Gate');
  var text_output = block.getFieldValue('Output');
  var text_input = block.getFieldValue('Input');
  // TODO: Assemble JavaScript into code variable.
  var code = '	'+dropdown_gate+' ('+text_output+','+text_input+');\n';
  return code;
};