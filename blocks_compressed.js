...
Blockly.Blocks['input'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("Input"), "Type")
		.appendField(new Blockly.FieldNumber(1, 1, 32), "Bit")
        .appendField(new Blockly.FieldTextInput("in"), "Value");
...
Blockly.Blocks['output'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("Output"), "Type")
		.appendField(new Blockly.FieldNumber(1, 1, 32), "Bit")
        .appendField(new Blockly.FieldTextInput("out"), "Value");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(210);
 this.setTooltip("");
...
Blockly.Blocks['wire'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("wire"), "Type")
		.appendField(new Blockly.FieldNumber(1, 1, 32), "Bit")
        .appendField(new Blockly.FieldTextInput("w"), "Value");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(180);
 this.setTooltip("");
...
Blockly.Blocks['reg'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldLabelSerializable("reg"), "Type")
		.appendField(new Blockly.FieldNumber(1, 1, 32), "Bit")
        .appendField(new Blockly.FieldTextInput("r"), "Value");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(140);
 this.setTooltip("");
...
Blockly.Blocks['gate'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Gate")
        .appendField(new Blockly.FieldDropdown([["and","and"], ["or","or"], ["xor","xor"],["nand","nand"], ["nor","nor"], ["xnor","xnor"]]), "Gate")
    //this.appendDummyInput()
        .appendField("Output")
        .appendField(new Blockly.FieldTextInput("out"), "Output")
    //this.appendDummyInput()
        .appendField("Input1")
        .appendField(new Blockly.FieldTextInput("in"), "Input1")
	//this.appendDummyInput()
        .appendField("Input2")
        .appendField(new Blockly.FieldTextInput("in2"), "Input2");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
...
Blockly.Blocks['gateinout'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("Gate")
        .appendField(new Blockly.FieldDropdown([["not","not"], ["buf","buf"]]), "Gate")
    //this.appendDummyInput()
        .appendField("Output")
        .appendField(new Blockly.FieldTextInput("out"), "Output")
    //this.appendDummyInput()
        .appendField("Input")
        .appendField(new Blockly.FieldTextInput("in"), "Input");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
 this.setTooltip("");
